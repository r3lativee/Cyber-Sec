        ...
        >
            ...
            <div className="max-w-7xl w-full mx-auto relative z-30 flex flex-col items-start text-left">
                <div className="space-y-4 mb-8 md:mb-12">
                    ...
                    <h1 className="text-3xl sm:text-6xl md:text-8xl lg:text-9xl xl:text-[10rem] font-bold font-heading leading-[1.1] md:leading-[0.85] tracking-tighter stagger-text uppercase">
                        MASTER <br className="hidden sm:block" />
                        <span className="text-primary ">CYBERSECURITY</span> <br className="hidden sm:block" />
                        SKILLS
                    </h1>

                    <p className="stagger-text text-muted text-xs md:text-lg font-mono leading-relaxed max-w-2xl py-2 mt-4 md:mt-8 opacity-80">
                ...
                <div className="flex flex-col sm:flex-row justify-start gap-4 stagger-text mt-8 md:mt-16 w-full font-mono">
                    <button className="group relative px-8 md:px-10 py-4 md:py-5 bg-primary text-background font-bold uppercase tracking-wider text-xs md:text-sm overflow-hidden transition-all duration-300 w-full sm:w-auto text-center">
                        <span className="relative z-10">Start Hacking Now</span>
                        <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity"></div>
                    </button>
                    <button className="group relative px-8 md:px-10 py-4 md:py-5 border border-primary/30 text-primary font-bold uppercase tracking-wider text-xs md:text-sm transition-all duration-300 hover:border-primary w-full sm:w-auto text-center">
